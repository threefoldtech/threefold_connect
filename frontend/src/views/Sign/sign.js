...
export default {
    ...
    methods: {
        ...
        async promptToSignMobile() {
            ...
            if (this.isMobile) {
                var url = `${config.deeplink}sign/?state=${encodeURIComponent(
          this._state
        )}&randomRoom=${this.randomRoom}`;
                if (this.appId) url += `&appId=${encodeURIComponent(this.appId)}`;
                if (dataHash)
                    url += `&dataHash=${encodeURIComponent(this.dataUrlHash)}`;
                ...
                if (friendlyName)
                    url += `&friendlyName=${encodeURIComponent(this.friendlyName)}`;
            }
